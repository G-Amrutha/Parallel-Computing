ARCHITECTURE TORUS(24); /* Sets up the torus architecture with 6 rows and columns for the processors. - A_Ginkala */
#define m 24 /* Defines the number of rows/columns in the torus architecture. - A_Ginkala */
#define p 2 /* Defines the size of the square partition of the matrices. - A_Ginkala */
